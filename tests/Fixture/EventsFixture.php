...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'file' => ['type' => 'string', 'length' => 200, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-09 12:57:24',
                'modified' => '2018-07-09 12:57:24'
            ],
        ];
        parent::init();
    }
